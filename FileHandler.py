...
class FileHandler:
    ...
    def getFileData(self, frames, reverse=False, includeInterpolationBuffer=True):
        ...
        frames = frames * 2 + 6 if includeInterpolationBuffer else frames * 2
        ...
        #subtract interpolation buffer to end up on correct index
        if includeInterpolationBuffer:
            frames -= 6
